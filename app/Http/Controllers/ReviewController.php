...
class ReviewController extends Controller
{
    public function index($id)
    {
        ...
        return view('reviews.index', ["reviews" => $association->reviews,    "association" => $association]);
    }
    ...
    public function store(Request $request,$id)
    {
        ...
        return redirect()->route('reviews.index',$id)->with('success', 'Review added successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('reviews.index',$review->association_id)->with('success', 'Review updated successfully.');
    }
    ...
    public function destroy($id)
    {
        $review = Review::findOrFail($id);
        $review->delete();
        return redirect()->route('reviews.index',$review->association_id)->with('success', 'Review deleted successfully.');
    }
