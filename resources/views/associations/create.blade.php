...
<div class="hero-section position-relative" style="background: url('{{ asset('assets/images/partner.png') }}') no-repeat center center; background-size: cover; padding: 80px 0 120px;">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" name="nom" class="form-control rounded-pill shadow-sm" value="{{ old('nom') }}" required>
    </div>

    <!-- Address -->
    <div class="form-group mb-3">
        <label for="address" class="form-label"><i class="mdi mdi-map-marker"></i> Address</label>
        <input type="text" name="addresse" class="form-control rounded-pill shadow-sm" value="{{ old('addresse') }}" required>
    </div>

    <!-- Phone -->
    <div class="form-group mb-3">
        <label for="phone" class="form-label"><i class="mdi mdi-phone"></i> Phone</label>
        <input type="text" name="telephone" class="form-control rounded-pill shadow-sm" value="{{ old('telephone') }}" required>
    </div>
