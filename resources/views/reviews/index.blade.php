...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="container text-center text-white position-relative mb-5"
            style="background-color: rgba(0, 0, 0, 0.7); padding: 20px; border-radius: 10px; background-image: url({{ $association->image ?  asset('storage/' . $association->image) : 'https://blog.ipleaders.in/wp-content/uploads/2021/09/register-company-online-1.png' }}); min-height:300px; background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-4">
                        <form action="{{ route('reviews.store',$association->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
